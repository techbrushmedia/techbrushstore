...
ABOUT_PAGE = """
<h2 class="font-bold text-left text-xl w-full">About techbrushshop</h2>
<p class="py-3">techbrushshop is an online store built around a clear collection, simple ordering, and thoughtful service.</p>
...
def rename_default_brand(apps, schema_editor):
    ...
    Config.objects.filter(pk=1, site_title='Nixagone').update(
        site_title='techbrushshop',
